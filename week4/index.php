...
<body>
                ...
                <?php
                 if (!empty($users)) {
                    for ($i = 0; $i < count($users); $i++) {
                        echo '
                        <div class="col-md-4">
                            <div class="card border-warning mb-2 mt-2 rounded-3x">
                                <div class="card-header bg-warning-subtle">
                                    <h5 class="text-primary-emphasis fs-3">' . $users[$i]['name'] . '</h5>
                                    <p class="card-text text-secondary">' . $users[$i]['email'] . '</p>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-subtitle text-warning-emphasis fw-bold mb-2">Address</h6>
                                    ...
                                    <h6 class="card-subtitle text-warning-emphasis border-top fw-bold py-2">Company</h6>
    ...
    <div class="container">
        <h3 class="mt-5">For Each Data</h3>
        <div class="row">
                <?php
                 if (!empty($users)) {
                    foreach ($users as $user){
                        echo '
                        <div class="col-md-4">
                            <div class="card border-danger mb-2 mt-2">
                                <div class="card-header bg-danger-subtle">
                                    <h5 class="fw-bold text-danger-emphasis">' . $user['name'] . '</h5>
                                    <p class="card-text text-secondary">' . $user['email'] . '</p>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-subtitle text-danger-emphasis fw-bold mb-2">Address</h6>
                                    ...
                                    <p class="card-text"><span class="fw-bold card-link">Website: </span>' . $user['website'] . '</p>
                                    <h6 class="card-subtitle text-danger-emphasis border-top fw-bold py-2">Company</h6>
